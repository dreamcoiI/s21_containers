...
TEST(Set, Constructor_Initializer_list) {
  s21::multiset<int> s21_set = {1, 2, 3, 4};
...
TEST(Set, Constructor_Move) {
  s21::multiset<char> s21_set_1 = {'a', 'b', 'c', 'd'};
  std::multiset<char> std_set_1 = {'a', 'b', 'c', 'd'};
  s21::multiset<char> s21_set_2 = std::move(s21_set_1);
  std::multiset<char> std_set_2 = std::move(std_set_1);
...
TEST(Set, Modifier_Insert_1) {
  s21::multiset<char> s21_set_1 = {'a', 'c', 'd'};
  s21::multiset<char> s21_set_2 = {'a', 'c', 'd', 'b'};
  ...
  EXPECT_NE(s21_set_1.size(), s21_set_2.size());
}
...
TEST(Set, Modifier_Insert_2) {
  ...
  EXPECT_EQ(s21_set.size(), size_t(3));
}

TEST(Set, Modifier_Insert_3) {
  s21::multiset<float> s21_set;
  std::multiset<float> std_set;
...
TEST(Set, Modifier_Erase) {
  s21::multiset<char> s21_set_1 = {'a', 'c', 'd'};
  s21::multiset<char> s21_set_2 = {'a', 'b', 'c', 'd'};
...
TEST(Set, Modifier_Swap) {
  s21::multiset<char> s21_set_1 = {'a', 'b', 'o', 'b', 'a'};
  s21::multiset<char> s21_set_2 = {'s', 'h', 'l', 'e', 'p', 'p', 'a'};
  s21::multiset<char> s21_set_3 = {'a', 'b', 'o', 'b', 'a'};
  s21::multiset<char> s21_set_4 = {'s', 'h', 'l', 'e', 'p', 'p', 'a'};
...
TEST(Set, Rehash_And_Insert_In_Collision) {
  s21::multiset<std::string> s21_set;
